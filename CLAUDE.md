...
- **ค่าปรับ (penalty)** = กรอกเองตอนรับเงิน (เติม default จาก `branches.penalty_fee`), **แยกจากดอก/ต้น (ไม่กระทบยอดปิดสัญญา)** แต่**นับรวมในฐานคำนวณค่าแรง 20%**, เก็บที่ `daily_records.penalty`
