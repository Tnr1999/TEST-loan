...
- `head` = **หัวหน้ากอง** — เห็นทุกบ้านในกองตัวเอง (ผูกผ่าน `user_groups`) · รับค่าคอมของกอง · จัดการบ้านในกองได้
- `line` = **หัวหน้าสาย** — เห็นเฉพาะบ้านที่ดูแล (ผูกผ่าน `user_branches`) · แก้ไข/รับเงิน/ปิดสินเชื่อได้ · ไม่จัดการโครงสร้างบ้าน *(role เดิม `manager` ถือเป็นหัวหน้าสายด้วย)*
